...
type Database struct {
	diskdb eaidb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb eaidb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch eaidb.Batch) error {
	// If the node does not exist, it's a previously committed node
