...
import (
	...
	"github.com/ethereumai/go-ethereumai/signer/core"
	"github.com/ethereumai/go-ethereumai/signer/storage"
)
...
func (alwaysDenyUI) OnApprovedTx(tx eaiapi.SignTransactionResult) {
	panic("implement me")
}
...
func (d *dummyUI) OnApprovedTx(tx eaiapi.SignTransactionResult) {
...
func TestForwarding(t *testing.T) {
	...
	r.OnApprovedTx(eaiapi.SignTransactionResult{})
...
func TestLimitWindow(t *testing.T) {
	...
	// 0.3 etherai: 429D069189E0000 wei
	...
	for i := 0; i < 3; i++ {
		...
		response := eaiapi.SignTransactionResult{
			Tx:  dummySigned(v),
...
func (d *dontCallMe) OnApprovedTx(tx eaiapi.SignTransactionResult) {
	d.t.Fatalf("Did not expect next-handler to be called")
}
