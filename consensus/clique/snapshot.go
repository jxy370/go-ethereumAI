...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db eaidb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db eaidb.Database) error {
