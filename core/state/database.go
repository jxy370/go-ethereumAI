...
// Trie is a EthereumAI Merkle Trie.
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb eaidb.Putter) error
}
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb eaidb.Putter) error {
