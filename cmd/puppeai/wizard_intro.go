...
// makeWizard creates and returns a new puppeai wizard.
...
// setting up a new or managing an existing EthereumAI private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeai, your EthereumAI private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new EthereumAI network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and eaistats servers |")
	fmt.Println("| without the hassle that it would normally entail.         |")
	fmt.Println("|                                                           |")
	fmt.Println("| Puppeai uses SSH to dial in to remote servers, and builds |")
	...
	log.Info("Administering EthereumAI network", "name", w.network)

	// Load initial configurations and connect to all live servers
	w.conf.path = filepath.Join(os.Getenv("HOME"), ".puppeai", w.network)
