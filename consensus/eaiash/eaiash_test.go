...
// Tests that eaiash works correctly in test mode.
func TestTestMode(t *testing.T) {
	...
	if err := eaiash.VerifySeal(nil, head); err != nil {
...
func verifyTest(wg *sync.WaitGroup, e *Eaiash, workerIndex, epochs int) {
	defer wg.Done()
