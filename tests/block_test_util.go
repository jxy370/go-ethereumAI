...
// Package tests implements execution of EthereumAI JSON tests.
package tests
...
func (t *BlockTest) Run() error {
	...
	chain, err := core.NewBlockChain(db, nil, config, eaiash.NewShared(), vm.Config{})
	if err != nil {
		return err
	}
	defer chain.Stop()
...
/* See https://github.com/ethereumai/tests/wiki/Blockchain-Tests-II
