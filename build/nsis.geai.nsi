...
# 1. install geai for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for geai
# 5. create geai, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable ETHEREUMAI_SOCKET
...
!define GROUPNAME "EthereumAI"
!define APPNAME "Geai"
!define DESCRIPTION "Official Go implementation of the EthereumAI protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since geai is installed global
