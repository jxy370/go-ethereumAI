...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "geai.ipc", false, filepath.Join(os.TempDir(), "geai.ipc")},
		{"data", "geai.ipc", false, "data/geai.ipc"},
		{"data", "./geai.ipc", false, "./geai.ipc"},
		{"data", "/geai.ipc", false, "/geai.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "geai.ipc", true, `\\.\pipe\geai.ipc`},
		{"data", "geai.ipc", true, `\\.\pipe\geai.ipc`},
		{"data", `\\.\pipe\geai.ipc`, true, `\\.\pipe\geai.ipc`},
	}
