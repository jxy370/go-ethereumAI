...
// account array.
func checkStateAccounts(t *testing.T, db eaidb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db eaidb.Database, root common.Hash) error {
...
func checkStateConsistency(db eaidb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, eaidb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(eaidb.Database), srcRoot)
