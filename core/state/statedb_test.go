...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := eaidb.NewMemDatabase()
	finalDb := eaidb.NewMemDatabase()
...
// https://github.com/ethereumai/go-ethereumai/pull/15549.
func TestCopy(t *testing.T) {
	// Create a random state test to copy and modify "independently"
	orig, _ := New(common.Hash{}, NewDatabase(eaidb.NewMemDatabase()))
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(eaidb.NewMemDatabase()))
...
// See https://github.com/ethereumai/go-ethereumai/pull/15225#issuecomment-380191512
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(eaidb.NewMemDatabase()))
